...
1. Полностью отключить источник звука. Для включения этого режима необходимо установить соответствующий флажок в окне настроек дополнения.
...
* существенно оптимизирован исходный код и добавлено MyPy аннотации типов;
